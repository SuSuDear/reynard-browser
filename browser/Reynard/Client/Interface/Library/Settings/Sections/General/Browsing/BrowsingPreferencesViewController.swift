...
final class BrowsingPreferencesViewController: SettingsTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .links:
            ...
            return cell
        case .media:
            guard MediaRow.allCases.indices.contains(indexPath.row) else { return UITableViewCell() }
        ...
        case .desktopWebsite:
            guard DesktopWebsiteRow.allCases.indices.contains(indexPath.row) else { return UITableViewCell() }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .links:
            return
        case .media:
            guard MediaRow.allCases.indices.contains(indexPath.row) else { return }
            switch MediaRow.allCases[indexPath.row] {
            case .autoplay:
